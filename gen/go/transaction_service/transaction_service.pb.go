...
type TransferFundsRequest struct {
	...
	FromUserEmail string                 `protobuf:"bytes,4,opt,name=from_user_email,json=fromUserEmail,proto3" json:"from_user_email,omitempty"`
...
func (x *TransferFundsRequest) GetFromUserEmail() string {
	if x != nil {
		return x.FromUserEmail
	}
	return ""
}
...
const file_proto_transaction_service_proto_rawDesc = "" +
	"\n" +
	"\x1fproto/transaction_service.proto\x12\vtransaction\"\x96\x01\n" +
	...
	"\x0ffrom_user_email\x18\x04 \x01(\tR\rfromUserEmail\"\x8a\x01\n" +
